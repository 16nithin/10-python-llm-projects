...
print("✅ vector_store.py patched with local embeddings!")
print("   Indexing now works with NO API calls.")
print("   Gemini is still used for generating answers.")
print("")
